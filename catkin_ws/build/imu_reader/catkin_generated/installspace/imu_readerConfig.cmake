...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_reader' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jo/farm_bot_workspace/catkin_ws/install/${idir}'.  Ask the maintainer 'jo <jo@todo.todo>' to fix it.")
    endif()
