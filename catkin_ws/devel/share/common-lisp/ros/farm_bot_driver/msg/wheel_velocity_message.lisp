...
(cl:defclass <wheel_velocity_message> (roslisp-msg-protocol:ros-message)
  ((FR_vel
    :reader FR_vel
    :initarg :FR_vel
    :type cl:integer
...
(cl:defclass wheel_velocity_message (<wheel_velocity_message>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <wheel_velocity_message>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'wheel_velocity_message)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name farm_bot_driver-msg:<wheel_velocity_message> is deprecated: use farm_bot_driver-msg:wheel_velocity_message instead.")))

(cl:ensure-generic-function 'FR_vel-val :lambda-list '(m))
(cl:defmethod FR_vel-val ((m <wheel_velocity_message>))
...
(cl:defmethod FL_vel-val ((m <wheel_velocity_message>))
...
(cl:defmethod BR_vel-val ((m <wheel_velocity_message>))
...
(cl:defmethod BL_vel-val ((m <wheel_velocity_message>))
  ...
  (BL_vel m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <wheel_velocity_message>) ostream)
  "Serializes a message object of type '<wheel_velocity_message>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <wheel_velocity_message>) istream)
  "Deserializes a message object of type '<wheel_velocity_message>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<wheel_velocity_message>)))
  "Returns string type for a message object of type '<wheel_velocity_message>"
  "farm_bot_driver/wheel_velocity_message")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'wheel_velocity_message)))
  "Returns string type for a message object of type 'wheel_velocity_message"
  "farm_bot_driver/wheel_velocity_message")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<wheel_velocity_message>)))
  "Returns md5sum for a message object of type '<wheel_velocity_message>"
  "329705fbf5edc3538e8d30fb491f55ed")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'wheel_velocity_message)))
  "Returns md5sum for a message object of type 'wheel_velocity_message"
  "329705fbf5edc3538e8d30fb491f55ed")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<wheel_velocity_message>)))
  "Returns full string definition for message of type '<wheel_velocity_message>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'wheel_velocity_message)))
  "Returns full string definition for message of type 'wheel_velocity_message"
  (cl:format cl:nil "# Message structure for wheel angular velocities for Dynamixel series AX~%# FR - Front right / FL - Front left / BR - Back right / BL - Back left~%# Each wheel can only have positive angular velocities~%~%uint32 FR_vel~%uint32 FL_vel~%uint32 BR_vel~%uint32 BL_vel~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <wheel_velocity_message>))
  (cl:+ 0
     4
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <wheel_velocity_message>))
  "Converts a ROS message object to a list"
  (cl:list 'wheel_velocity_message
